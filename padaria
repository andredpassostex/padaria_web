# Salve como padaria_web.py e rode com: streamlit run padaria_web.py import streamlit as st import pandas as pd from datetime import datetime
...
menu = ["Cadastro Produto", "Cadastro Funcionário", "Registrar Venda", "Relatórios", "Estoque e Caixa"] choice = st.sidebar.selectbox("Menu", menu)
